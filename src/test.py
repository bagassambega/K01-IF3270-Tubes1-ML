...
ffnn = FFNN(x=temp_x, y=temp_y, x_val=temp_x_val, y_val=temp_y_val, layers=[3], loss_function="mse", weight_method="xavier", learning_rate=0.1, activations=["relu", "softmax"], verbose=True, epochs=3, seed=42)
